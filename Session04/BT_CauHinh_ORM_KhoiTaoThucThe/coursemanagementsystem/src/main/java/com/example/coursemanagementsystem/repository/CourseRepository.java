...
public class CourseRepository {
    ...
    public CourseRepository() {
        courses.add(new Course(1L, "Intro Java", CourseStatus.ACTIVE, 1L));
        courses.add(new Course(2L, "Spring Boot Advanced", CourseStatus.INACTIVE, 1L));
        courses.add(new Course(3L, "Introduction to IoT", CourseStatus.INACTIVE, 2L));
    }
