...
public class CourseServiceTest {
    ...
    void testGetPagedCourses_PageLessThanZero_AdjustsToZero() {
        ...
        Page<CourseResponse> result = courseService.getPagedCourses(-5, 5, "title", Sort.Direction.ASC);
    ...
    void testGetPagedCourses_NullSortBy_DefaultsToId() {
        ...
        Page<CourseResponse> result = courseService.getPagedCourses(0, 10, null, Sort.Direction.DESC);
    ...
    void testGetPagedCourses_EmptySortBy_DefaultsToId() {
        ...
        Page<CourseResponse> result = courseService.getPagedCourses(2, 20, "   ", Sort.Direction.ASC);
